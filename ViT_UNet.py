...
class Embeddings(nn.Module):
    ...
    def __init__(self, img_size):
        ...
        self.patch_embeddings = Conv3d(in_channels=128,
...
class ViT(nn.Module):
    def __init__(self, img_size):
        ...
        self.down_factor = 2
        self.conv_more = Conv3dReLU(252, 128, kernel_size=3, padding=1, use_batchnorm=True)
...
class Discriminator(nn.Module):
    def __init__(self, in_channels=1):
        ...
        self.conv3 = CNNencoder(nf*2, nf*4)
        self.conv4 = CNNencoder(nf*4, nf*8)
        self.conv5 = CNNencoder(nf*8, nf*16)
